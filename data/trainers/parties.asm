...
FalknerGroup:
	...
	db  7, HOOTHOOT,     TACKLE, MUD_SLAP, GROWL, NO_MOVE
...
MortyGroup:
	...
	db 23, MISDREAVUS, SPITE, MEAN_LOOK, SHADOW_BALL, CONFUSE_RAY
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 31, DELIBIRD,   PRESENT, ICY_WIND, FLY, ICE_BEAM
	db 31, DEWGONG,    HEADBUTT, ICY_WIND, WATERFALL, REST
	db 33, SNEASEL,    ICE_PUNCH, FAINT_ATTACK, QUICK_ATTACK, SCREECH
	db 35, PILOSWINE,  ICY_WIND, HORN_ATTACK, MIST, BLIZZARD
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_MOVES
	db 32, SKARMORY,   SAND_ATTACK, FLY, STEEL_WING, LEER
...
ChuckGroup:
	...
	db 29, HITMONTOP,  TRIPLE_KICK, QUICK_ATTACK, PURSUIT, FOCUS_ENERGY
...
ClairGroup:
	...
	db 37, DRAGONAIR,  THUNDER_WAVE, FLAMETHROWER, HEADBUTT, DRAGONBREATH
	db 37, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, HEADBUTT, DRAGONBREATH
	db 37, DRAGONAIR,  THUNDER_WAVE, ICE_BEAM, HEADBUTT, DRAGONBREATH
...
Rival1Group:
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, CROCONAW,   LEER, SCRATCH, WATER_GUN, BITE
	db -1 ; end
	...
	db 32, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 34, SNEASEL,    ICY_WIND, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 35, QUILAVA,    SMOKESCREEN, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 32, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 34, SNEASEL,    ICY_WIND, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 35, FERALIGATR, ICE_PUNCH, WATER_GUN, BITE, SCARY_FACE
	db -1 ; end

	; RIVAL1 (13)
	db "?@", TRAINERTYPE_MOVES
	db 36, SNEASEL,    QUICK_ATTACK, SCREECH, FAINT_ATTACK, ICE_PUNCH
	...
	db 40, MEGANIUM,   REFLECT, RAZOR_LEAF, TOXIC, BODY_SLAM
	db -1 ; end
	...
	db 37, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 37, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 40, TYPHLOSION, SMOKESCREEN, THUNDERPUNCH, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 37, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 37, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 40, FERALIGATR, ICE_PUNCH, WATERFALL, SCARY_FACE, SLASH
	db -1 ; end
...
WillGroup:
	...
	db 60, ALAKAZAM,  TWISTEDSPOON,  REFLECT, RECOVER, FIRE_PUNCH, PSYCHIC_M
	db 61, JYNX,      NEVERMELTICE,  DOUBLESLAP, LOVELY_KISS, ICE_BEAM, PSYCHIC_M
	db 61, EXEGGUTOR, MIRACLE_SEED,  REFLECT, LEECH_SEED, GIGA_DRAIN, PSYCHIC_M
	db 61, MR__MIME,  LEFTOVERS,     LIGHT_SCREEN, PSYCHIC_M, SUBSTITUTE, THUNDERBOLT
	db 61, SLOWBRO,   MINT_BERRY,    REST, AMNESIA, SURF, PSYCHIC_M
	db 62, XATU,      SPELL_TAG,     SHADOW_BALL, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	db -1 ; end
...
BrunoGroup:
	...
	db 42, HITMONTOP,  TRIPLE_KICK, QUICK_ATTACK, DIG, DETECT
	...
	db 62, HITMONTOP,   BLACKBELT_I,  TRIPLE_KICK, HEADBUTT, DIG, DETECT
	db 62, HITMONLEE,   BLACKBELT_I,  SWAGGER, DOUBLE_KICK, HI_JUMP_KICK, FORESIGHT
	db 62, HITMONCHAN,  BLACKBELT_I,  THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	db 63, STEELIX,     LEFTOVERS,    IRON_TAIL, EARTHQUAKE, SANDSTORM, ROCK_SLIDE
	db 62, HERACROSS,   FOCUS_BAND,   MEGAHORN, REVERSAL, HEADBUTT, FOCUS_ENERGY
	db 66, MACHAMP,     SCOPE_LENS,   ROCK_SLIDE, FOCUS_ENERGY, VITAL_THROW, CROSS_CHOP
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_MOVES
	db 42, UMBREON,    SAND_ATTACK, CONFUSE_RAY, FAINT_ATTACK, MOONLIGHT
	db 42, VILEPLUME,  STUN_SPORE, SLUDGE_BOMB, MOONLIGHT, PETAL_DANCE
	db 45, GENGAR,     SHADOW_BALL, CONFUSE_RAY, CURSE, DESTINY_BOND
	...
	db 62, UMBREON,    LEFTOVERS,    SAND_ATTACK, CONFUSE_RAY, FAINT_ATTACK, MOONLIGHT
	db 62, VILEPLUME,  LEFTOVERS,    STUN_SPORE, SLUDGE_BOMB, MOONLIGHT, PETAL_DANCE
	db 65, GENGAR,     SPELL_TAG,    SHADOW_BALL, CONFUSE_RAY, SLUDGE_BOMB, DESTINY_BOND
	db 64, MURKROW,    SHARP_BEAK,   DRILL_PECK, WHIRLWIND, PURSUIT, FAINT_ATTACK
	db 64, TYRANITAR,  BLACKGLASSES, ROCK_SLIDE, CRUNCH, SANDSTORM, EARTHQUAKE
	db 67, HOUNDOOM,   CHARCOAL,     ROAR, PURSUIT, FLAMETHROWER, CRUNCH
	db -1 ; end

KogaGroup:
	; KOGA (1)
	db "KOGA@", TRAINERTYPE_MOVES
	db 40, ARIADOS,    DOUBLE_TEAM, SPIDER_WEB, CUT, SLUDGE_BOMB
	...
	db 44, CROBAT,     DOUBLE_TEAM, SLUDGE_BOMB, WING_ATTACK, TOXIC
	db -1 ; end

	; KOGA (2)
	db "KOGA@", TRAINERTYPE_ITEM_MOVES
	db 60, ARIADOS,    SILVERPOWDER, DOUBLE_TEAM, SPIDER_WEB, CUT, SLUDGE_BOMB
	db 61, VENOMOTH,   TWISTEDSPOON, SUPERSONIC, LEECH_LIFE, PSYCHIC_M, TOXIC
	db 62, WEEZING,    POISON_BARB,  FLAMETHROWER, THUNDERBOLT, SLUDGE_BOMB, TOXIC
	db 63, FORRETRESS, QUICK_CLAW,   PROTECT, HEADBUTT, EXPLOSION, SPIKES
	db 62, MUK,        LEFTOVERS,    MINIMIZE, ACID_ARMOR, SLUDGE_BOMB, TOXIC
	db 64, CROBAT,     SHARP_BEAK,   DOUBLE_TEAM, SLUDGE_BOMB, WING_ATTACK, TOXIC
	db -1 ; end

ChampionGroup:
	; CHAMPION (1)
	db "LANCE@", TRAINERTYPE_MOVES
	db 44, GYARADOS,   DRAGONBREATH, RAIN_DANCE, SURF, HYPER_BEAM
	...
	db 46, AERODACTYL, FLY, STEEL_WING, ROCK_SLIDE, HYPER_BEAM
	db 46, CHARIZARD,  FLAMETHROWER, WING_ATTACK, SLASH, HYPER_BEAM
	db 50, DRAGONITE,  FIRE_BLAST, THUNDER_WAVE, OUTRAGE, HYPER_BEAM
	db -1 ; end

	; CHAMPION (2)
	db "LANCE@", TRAINERTYPE_ITEM_MOVES
	db 64, GYARADOS,   MYSTIC_WATER,  DRAGONBREATH, RAIN_DANCE, SURF, HYPER_BEAM
	db 67, DRAGONITE,  MAGNET,        THUNDER_WAVE, DRAGONBREATH, THUNDER, HYPER_BEAM
	db 67, DRAGONITE,  NEVERMELTICE,  THUNDER_WAVE, DRAGONBREATH, BLIZZARD, HYPER_BEAM
	db 66, AERODACTYL, METAL_COAT,    FLY, STEEL_WING, ROCK_SLIDE, HYPER_BEAM
	db 66, CHARIZARD,  PINK_BOW,      FLAMETHROWER, WING_ATTACK, SLASH, HYPER_BEAM
	db 70, DRAGONITE,  CHARCOAL,      FIRE_BLAST, THUNDER_WAVE, OUTRAGE, HYPER_BEAM
	db -1 ; end

BrockGroup:
	; BROCK (1)
	db "BROCK@", TRAINERTYPE_MOVES
	db 41, ONIX,       BIND, ROCK_SLIDE, BIDE, SANDSTORM
	db 41, RHYHORN,    FURY_ATTACK, SCARY_FACE, EARTHQUAKE, HORN_DRILL
	db 42, OMASTAR,    BITE, SURF, PROTECT, SPIKE_CANNON
	db 44, GOLEM,      DEFENSE_CURL, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
...
LtSurgeGroup:
	...
	db 44, RAICHU,     THUNDER_WAVE, QUICK_ATTACK, THUNDERBOLT, DOUBLE_TEAM
	db 42, ELECTRODE,  SCREECH, DOUBLE_TEAM, THUNDERBOLT, EXPLOSION
	db 42, MAGNETON,   LOCK_ON, DOUBLE_TEAM, SWIFT, ZAP_CANNON
	db 42, ELECTRODE,  SCREECH, DOUBLE_TEAM, THUNDERBOLT, EXPLOSION
	db 46, ELECTABUZZ, QUICK_ATTACK, THUNDERBOLT, LIGHT_SCREEN, PSYCHIC_M
	db -1 ; end
...
ErikaGroup:
	...
	db 46, VICTREEBEL, SUNNY_DAY, SYNTHESIS, SLUDGE_BOMB, RAZOR_LEAF
...
JanineGroup:
	...
	db 43, CROBAT,     SLUDGE_BOMB, TOXIC, CONFUSE_RAY, WING_ATTACK
	db 42, WEEZING,    FLAMETHROWER, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 42, WEEZING,    THUNDERBOLT, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 43, ARIADOS,    SPIDER_WEB, GIGA_DRAIN, CUT, SLUDGE_BOMB
	db 46, VENOMOTH,   LEECH_LIFE, DOUBLE_TEAM, SLUDGE_BOMB, PSYCHIC_M
	db -1 ; end
...
GruntMGroup:
	...
	db 14, KOFFING,  TACKLE, SMOG, POISON_GAS, SELFDESTRUCT
	db 12, MACHOP,   KARATE_CHOP, LEER, FOCUS_ENERGY, NO_MOVE
	db -1 ; end
...
SabrinaGroup:
	...
	db 46, GIRAFARIG,  PSYCHIC_M, STOMP, CRUNCH, AMNESIA
	db 46, ESPEON,     SAND_ATTACK, SHADOW_BALL, BITE, PSYCHIC_M
	db 46, MR__MIME,   ICE_PUNCH, REFLECT, FIRE_PUNCH, PSYCHIC_M
	db 48, ALAKAZAM,   RECOVER, THUNDERPUNCH, PSYCHIC_M, REFLECT
	db -1 ; end
...
Rival2Group:
	...
	db 43, MAGNETON,   THUNDERBOLT, SONICBOOM, THUNDER_WAVE, SWIFT
	db 45, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 45, ALAKAZAM,   DISABLE, RECOVER, REFLECT, PSYCHIC_M
	db 47, MEGANIUM,   RAZOR_LEAF, TOXIC, BODY_SLAM, LIGHT_SCREEN
	db -1 ; end
	...
	db 45, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 45, ALAKAZAM,   DISABLE, RECOVER, REFLECT, PSYCHIC_M
	db 47, TYPHLOSION, SMOKESCREEN, QUICK_ATTACK, FLAME_WHEEL, THUNDERPUNCH
	db -1 ; end
	...
	db 45, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 45, ALAKAZAM,   DISABLE, RECOVER, REFLECT, PSYCHIC_M
	db 47, FERALIGATR, ICE_PUNCH, WATERFALL, SCARY_FACE, SLASH
	db -1 ; end

	; RIVAL2 (4)
	db "?@", TRAINERTYPE_MOVES
	db 47, SNEASEL,    QUICK_ATTACK, SCREECH, FAINT_ATTACK, ICE_PUNCH
	db 48, CROBAT,     TOXIC, BITE, CONFUSE_RAY, WING_ATTACK
	db 47, MAGNETON,   THUNDER, SONICBOOM, THUNDER_WAVE, SWIFT
	db 48, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 48, ALAKAZAM,   RECOVER, FIRE_PUNCH, PSYCHIC_M, REFLECT
	db 50, MEGANIUM,   GIGA_DRAIN, BODY_SLAM, LIGHT_SCREEN, TOXIC
	db -1 ; end
	...
	db 50, TYPHLOSION, SMOKESCREEN, QUICK_ATTACK, FLAMETHROWER, THUNDERPUNCH
	db -1 ; end
	...
	db 48, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 48, ALAKAZAM,   RECOVER, FIRE_PUNCH, PSYCHIC_M, REFLECT
	db 50, FERALIGATR, SURF, ICE_PUNCH, SLASH, SCREECH
	db -1 ; end
...
BlaineGroup:
	...
	db 45, NINETALES,  FLAMETHROWER, CONFUSE_RAY, FAINT_ATTACK, HYPNOSIS
	db 45, MAGCARGO,   CURSE, SMOG, FLAMETHROWER, ROCK_SLIDE
	db 45, MAGMAR,     THUNDERPUNCH, FIRE_PUNCH, SUNNY_DAY, CONFUSE_RAY
	db 50, RAPIDASH,   QUICK_ATTACK, FLAMETHROWER, HORN_ATTACK, FIRE_BLAST
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 35, KOFFING,    TACKLE, SLUDGE, SMOKESCREEN, SELFDESTRUCT
	db 37, HOUNDOOM,   FLAMETHROWER, SMOG, BITE, FAINT_ATTACK
	db -1 ; end

	; EXECUTIVEM (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 34, ZUBAT,      LEECH_LIFE, CONFUSE_RAY, WING_ATTACK, NO_MOVE
...
ExecutiveFGroup:
	; EXECUTIVEF (1)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 35, ARBOK,      HEADBUTT, ACID, BITE, GLARE
	db 35, VILEPLUME,  MEGA_DRAIN, POISONPOWDER, SLEEP_POWDER, ACID
	db 35, MURKROW,    DRILL_PECK, PURSUIT, HAZE, NIGHT_SHADE
	db -1 ; end

	; EXECUTIVEF (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 25, ARBOK,      HEADBUTT, LEER, ACID, BITE
	db 25, GLOOM,      MEGA_DRAIN, POISONPOWDER, SLEEP_POWDER, ACID
	db 27, MURKROW,    WING_ATTACK, PURSUIT, HAZE, NO_MOVE
	db -1 ; end
...
KimonoGirlGroup:
	...
	db 21, FLAREON,  SAND_ATTACK, EMBER, HEADBUTT, NO_MOVE
	db -1 ; end

	; KIMONO_GIRL (3)
	db "SAYO@", TRAINERTYPE_MOVES
	db 21, ESPEON,  SAND_ATTACK, CONFUSION, HEADBUTT, NO_MOVE
	db -1 ; end

	; KIMONO_GIRL (4)
	db "ZUKI@", TRAINERTYPE_MOVES
	db 21, UMBREON,  SAND_ATTACK, PURSUIT, HEADBUTT, NO_MOVE
	db -1 ; end

	; KIMONO_GIRL (5)
	db "KUNI@", TRAINERTYPE_MOVES
	db 21, VAPOREON,  SAND_ATTACK, WATER_GUN, HEADBUTT, NO_MOVE
	db -1 ; end

	; KIMONO_GIRL (6)
	db "MIKI@", TRAINERTYPE_MOVES
	db 21, JOLTEON,  SAND_ATTACK, THUNDERSHOCK, HEADBUTT, NO_MOVE
	db -1 ; end
...
RedGroup:
	...
	db 81, PIKACHU,    LIGHT_BALL,    CHARM, DOUBLE_TEAM, THUNDERBOLT, THUNDER
	db 73, ESPEON,     TWISTEDSPOON,  MUD_SLAP, REFLECT, SHADOW_BALL, PSYCHIC_M
...
BlueGroup:
	...
	db 56, PIDGEOT,    STEEL_WING, MUD_SLAP, WING_ATTACK, MIRROR_MOVE
	db 54, ALAKAZAM,   THUNDERPUNCH, RECOVER, PSYCHIC_M, REFLECT
	db 56, RHYDON,     HORN_ATTACK, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
	db 58, GYARADOS,   DRAGONBREATH, HYDRO_PUMP, RAIN_DANCE, HYPER_BEAM
	db 58, EXEGGUTOR,  SUNNY_DAY, LEECH_SEED, PSYCHIC_M, SOLARBEAM
	db 58, ARCANINE,   BITE, SWIFT, FLAMETHROWER, EXTREMESPEED
	db -1 ; end
