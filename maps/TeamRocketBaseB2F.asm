...
TeamRocketBaseB2F_MapEvents:
	...
	object_event  3, 10, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, TeamRocketBaseB2FTMEndure, EVENT_TEAM_ROCKET_BASE_B2F_TM_ENDURE
