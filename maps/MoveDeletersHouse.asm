...
MoveRelearnerScript: ; NEW FEATURE move relearner
	faceplayer
	opentext
...
MoveDeletersHouse_MapEvents:
	...
	object_event  5,  4, SPRITE_UNUSED_GUY, SPRITEMOVEDATA_STANDING_DOWN, 2, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, MoveRelearnerScript, -1
