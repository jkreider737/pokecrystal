...
SetMenuMonIconColor: ;  NEW FEATURE color party icons
	push hl
	push de
	push bc
	push af
...
InitPartyMenuIcon:
	call LoadPartyMenuMonIconColors ;  NEW FEATURE color party icons
	ld a, [wCurIconTile]
	push af
	ldh a, [hObjectStructIndex]
	ld hl, wPartySpecies
...
NamingScreen_InitAnimatedMonIcon:
	ld hl, wTempMonDVs ;  NEW FEATURE color party icons
...
MoveList_InitAnimatedMonIcon:
	ld a, MON_DVS ;  NEW FEATURE color party icons
	call GetPartyParamLocation
	call SetMenuMonIconColor
	ld a, [wTempIconSpecies]
	call ReadMonMenuIcon
...
FlyFunction_GetMonIcon:
	...
	ld a, [wTempIconSpecies] ;  NEW FEATURE color party icons
	ld [wCurPartySpecies], a
	ld a, MON_DVS
	call GetPartyParamLocation
	call GetMenuMonIconPalette
...
INCLUDE "data/pokemon/menu_icon_pals.asm" ;  NEW FEATURE color party icons
