...
InitPartyMenuOBPals:
	...
	ld de, wOBPals1
	ld bc, 8 palettes ;  NEW FEATURE color party icons
	ld a, BANK(wOBPals1)
	call FarCopyWRAM
	ret
...
.morn_day
	...
	ld a, [wMapGroup] ;  NEW FEATURE color party icons
	cp GROUP_ROUTE_34
	ret nz
...
SetFirstOBJPalette:: ;  NEW FEATURE color party icons
	ld hl, PartyMenuOBPals
	ld d, 0
	add hl, de
 	ld de, wOBPals1
...
LoadPokemonPalette: ; NEW FEATURE show color pokemon pictures in overworld
	ld a, [wCurPartySpecies]
	; hl = palette
	call GetMonPalettePointer
